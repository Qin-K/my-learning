...
public class OriginalNews {
    ...
    //显示时间
    @JSONField(name = "stime", format = "yyyy-MM-dd HH:mm:ss")
    ...
    //创建时间
    @JSONField(name = "ct", format = "yyyy-MM-ddTHH:mm:ss.SSS")
    ...
    //修改时间	增量获取的时间字段
    @JSONField(name = "ut", format = "yyyy-MM-ddTHH:mm:ss.SSS")
    ...
    //排序时间
    @JSONField(name = "odt", format = "yyyy-MM-ddTHH:mm:ss")
    ...
    //7*24显示样式
    @JSONField(name = "titlestyle")
    private int titleStyle;

    //web地址
    @JSONField(name = "Art_UniqueUrl")
    ...
    public void setStockView(int stockView) {
    ...
    public int getMediaTop() {
        return mediaTop;
    }

    public void setMediaTop(int mediaTop) {
